...
function(callback_before_target)
	if(NOT CMAKE_SYSTEM_NAME STREQUAL "Android" AND IS_DIRECTORY ${PACKAGE_DATA_DIR})
		if(IS_DIRECTORY ${JUGIMAP_FRAMEWORK_SOURCE_DIR})
			file(COPY ${JUGIMAP_FRAMEWORK_SOURCE_DIR}/examples_c++/ParallaxScrolling/media/fonts DESTINATION ${PACKAGE_DATA_DIR}/data/media)
			file(COPY ${JUGIMAP_FRAMEWORK_SOURCE_DIR}/examples_c++/ParallaxScrolling/media/graphics DESTINATION ${PACKAGE_DATA_DIR}/data/media)
			file(COPY ${JUGIMAP_FRAMEWORK_SOURCE_DIR}/examples_c++/ParallaxScrolling/media/maps DESTINATION ${PACKAGE_DATA_DIR}/data/media)
		endif()
